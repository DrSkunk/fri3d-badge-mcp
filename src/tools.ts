/**
 * Shared tool registrations for the fri3d-badge-mcp MCP server.
 *
 * Used by both the Vercel HTTP handler (api/server.ts) and the
 * standalone stdio CLI (src/server.ts) so tool definitions live in
 * exactly one place.
 */
...
} from "./sources/micropython.js";
import {
  getFri3dPage,
  listFri3dPages,
  searchFri3dDocs,
} from "./sources/fri3d.js";
import {
  getMicropythonOSPage,
  listMicropythonOSPages,
  searchMicropythonOSDocs,
} from "./sources/micropythonos.js";
